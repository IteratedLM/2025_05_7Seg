...
# -----------------------------------------------------------------------------
# 0) Build a 7‑segment “perfect” 28×28 digit (copy your make_7seg if you like)
# -----------------------------------------------------------------------------
...
filename="digits"
save_noisy7seg_h5(filename,n_per_digit=100,mu=0.015,sigma=2.0,rho=0.025,nSub=10)
